    ...
    return (
        <Container>
            ...
            <CarList 
                ...
                renderItem={({item})=><CardCar handleCarDetails={handleCarDetails} data={carOne}/>}
                />
        </Container>
    )
}